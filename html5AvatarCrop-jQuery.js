var html5AvatarCrop = {
  ...
  html_dom : "<div id='js_hac' class='hac-avatar-box'><div id='js_hac_label' class='hac-label'><canvas id='js_hac_get_image' class='hac-get-image'></canvas><div><canvas id='js_hac_cover_box' class='hac-cover-box'></canvas><canvas id='js_hac_edit_pic' class='hac-edit-pic'></canvas></div></div><div class='hac-croped-box'><span id='js_hac_show_edit' class='hac-show-edit'></span><button id='js_hac_save_button' class='hac-save-button'>确定</button><span id='js_hac_show_pic' class='hac-show-pic'><img src=''></span></div></div>",
  ...
  init: function() {
    ...
    $('#js_hac_post_file').on("change", t.handleFiles);
  ...
  handleFiles: function() {
    $('#js_hac_post_file').after(html5AvatarCrop.html_dom);
    $("#js_hac").css('display', 'block');
    ...
    $('#js_hac_save_button').on("click", html5AvatarCrop.saveCropedImage);
  },
  ...
  saveCropedImage: function () {
    ...
    images.onload = function(){
      ...
      $('#js_hac_show_pic').children('img')[0].src = t.editPic.toDataURL();
    }
  }
};
